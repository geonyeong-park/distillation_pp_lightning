...
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide1' --guide_step 1 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
...
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide3' --guide_step 3 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide4' --guide_step 4 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide5' --guide_step 5 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide6' --guide_step 6 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
python -m examples.run_mscoco --method "random++_lcm" --model "lcm" --cfg_guidance 8 --NFE 8 --seed 777 --workdir '/home/user/hdisk/distillation_pp_results/pixart/lcm_guide7' --guide_step 7 --prompt_dir examples/assets/pixart_prompts.txt --teacher_guidance 0.01
